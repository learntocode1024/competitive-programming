...
typedef uniform_int_distribution<i64> r32;
...
//const int n = 5000, m = 5000, q = 5000;

inline void sol() {
  O(n,m,q);
  FOR(i,1,n) cout << r32(0,m)(rng) << " \n"[i==n];
  FOR(i,1,q) {
    int l = r32(1,n)(rng), r = r32(1,n)(rng);
    if (l > r) swap(l, r);
    O((rng()&1)+1, l, r, r32(0,m)(rng));
  }
}
